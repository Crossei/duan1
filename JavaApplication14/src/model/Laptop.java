...
public class Laptop  implements java.io.Serializable {
    ...
    public Laptop(String malaptop, Hanglaptop hanglaptop, Nhacungcap nhacungcap, String tenlaptop, Integer soluong, Date ngaynhap, Integer giatien, Set<Hoadonchitiet> hoadonchitiets) {
       this.malaptop = malaptop;
       this.hanglaptop = hanglaptop;
       this.nhacungcap = nhacungcap;
